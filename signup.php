...
if (isset($_POST['submit'])) {
    ...
    if ($row > 0) {
        ...
        if ($msg) {
            ...
            $message = "Please click The following link For verifying and activation of your account <div style='padding-top:10px;'><a href='http://localhost/feedbacksystemfirstyear/loginsystem/email_verification.php?code=$activationcode'>Click Here</a></div>";
